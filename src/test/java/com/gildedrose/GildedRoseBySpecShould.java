...
public class GildedRoseBySpecShould {
    ...
    @Parameterized.Parameters(name = "{0}: Item {1}: Sell in days: {2}, quality: {3}, changes to quality: {4}")
    public static Collection<Object[]> data() {
        return Arrays.asList(
                new Object[][]{
                        ...
                        {"The Quality of Aged Brie increases by 1 when near sell in date of 1",
                        ...
                        {"The Quality of Aged Brie increases by 1 when item is near sell in date",
                                AGED_BRIE.toString(), sellIn(1), qualityOf(48), qualityOf(49)},
                        {"The Quality of Aged Brie increases by 2 when near to sell in date, about to expire",
                        ...
                        {"The Quality of Aged Brie can never more than 50 (near sell in date, about to expire)",
                        ...
                        {"Quality of Conjured items reduces by 2 only, if item is near expiry but not expired",
                                CONJURED_ITEM.toString(), sellIn(1), qualityOf(10), qualityOf(8)},
                        {"Quality of Conjured items reduces by 2, if item is near expiry but not expired",
