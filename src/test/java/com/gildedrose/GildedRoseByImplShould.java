    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
                new Object[][]{
                        ...
                        {"The quality of Standard item is 0, if Sell In days is past the date and quality is 2",
                                Constants.STANDARD_ITEM, sellIn(-1), qualityOf(2), sellIn(-2), qualityOf(0)},
                        {"The quality of Standard item is set to 0, if Sell In days is past the date and quality is 2",
